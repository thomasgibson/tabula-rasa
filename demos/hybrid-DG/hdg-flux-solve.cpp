...
template <typename Derived>
 static inline void subkernel1_cell_to_1_cell_integral_otherwise (const Eigen::MatrixBase<Derived> &  A_ , const double *restrict coords , const double *restrict w_0 )
{
  {
    Eigen::MatrixBase<Derived> &  A  = const_cast<Eigen::MatrixBase<Derived> &>(A_);
    ;
...
template <typename Derived>
 static inline void subkernel1_exterior_facet_to_2_exterior_facet_integral_1 (const Eigen::MatrixBase<Derived> &  A_ , const double *restrict coords , const double *restrict w_0 , const unsigned int  facet[1] )
{
  {
    Eigen::MatrixBase<Derived> &  A  = const_cast<Eigen::MatrixBase<Derived> &>(A_);
    ;
...
template <typename Derived>
 static inline void subkernel1_exterior_facet_to_2_exterior_facet_integral_2 (const Eigen::MatrixBase<Derived> &  A_ , const double *restrict coords , const double *restrict w_0 , const unsigned int  facet[1] )
{
  {
    Eigen::MatrixBase<Derived> &  A  = const_cast<Eigen::MatrixBase<Derived> &>(A_);
    ;
 ...
 static inline void compile_slate (double  A4[6] , double *  coords , double *  w_0 , double *  w_1 , double *  w_2 , double *  w_3 , double *  w_4 , double *  w_5 , double *  w_6 , double *  w_7 , int8_t *  arg_cell_facets )
{
  int8_t (*cell_facets)[2] = (int8_t (*)[2])arg_cell_facets;
  /* Declare and initialize */
  Eigen::Matrix<double, 15, 15, Eigen::RowMajor>  T0 ;
  T0.setZero();
  Eigen::Matrix<double, 15, 1>  T1 ;
  T1.setZero();
  ...
  subkernel1_cell_to_1_cell_integral_otherwise(T1.block<3, 1>(6, 0), coords, w_5);
  ...
  for (unsigned int  i0  = 0; i0 < 3; i0 += 1)
  {
    if (cell_facets[i0][0] == 0) {
      ...
      if (cell_facets[i0][1] == 1) {
        ...
        subkernel1_exterior_facet_to_2_exterior_facet_integral_1(T1.block<6, 1>(9, 0), coords, w_3, &i0);
       ...
       if (cell_facets[i0][1] == 2) {
        ...
        subkernel1_exterior_facet_to_2_exterior_facet_integral_2(T1.block<6, 1>(9, 0), coords, w_4, &i0);
  ...
  Eigen::Matrix<double, 6, 1>  VT2 ;
  VT2.setZero();
  Eigen::Matrix<double, 3, 1>  VT3 ;
  VT3.setZero();
  /* Loops for coefficient temps */
  
  for (unsigned int  i1  = 0; i1 < 6; i1 += 1)
  {
    
    for (unsigned int  j1  = 0; j1 < 1; j1 += 1)
    {
      VT2[0 + ((1 * i1) + j1)] = w_7[(i1 * 1) + j1];
      
    }
    
  }
  
  for (unsigned int  i1  = 0; i1 < 3; i1 += 1)
  {
    
    for (unsigned int  j1  = 0; j1 < 1; j1 += 1)
    {
      VT3[0 + ((1 * i1) + j1)] = w_6[(i1 * 1) + j1];
      
    }
    
  }
  /* Map eigen tensor into C struct */
  Eigen::Map<Eigen::Matrix<double, 6, 1> > T4((double *)A4);
  /* Linear algebra expression */
  T4 += ((T0).block<6, 6>(0, 0)).inverse() * (((T1).block<6, 1>(0, 0)) + (-((T0).block<6, 3>(0, 6)) * VT3) + (-((T0).block<6, 6>(0, 9)) * VT2));
...
PetscErrorCode wrap_compile_slate(int start,
                      int end,
                      double *arg0_0, int32_t *arg0_0_map0_0, double *arg1_0, int32_t *arg1_0_map0_0, double *arg2_0, int32_t *arg2_0_map0_0, double *arg3_0, int32_t *arg3_0_map0_0, double *arg4_0, double *arg5_0, int32_t *arg5_0_map0_0, double *arg6_0, int32_t *arg6_0_map0_0, double *arg7_0, int32_t *arg7_0_map0_0, double *arg8_0, int32_t *arg8_0_map0_0, double *arg9_0, int32_t *arg9_0_map0_0, int8_t *arg10_0
                      ) {
  PetscErrorCode ierr;
...
double buffer_arg7_0[3] ;
double buffer_arg8_0[3] ;
double buffer_arg9_0[6] __attribute__((aligned(16)));
...
for (int i_0=0; i_0<3; ++i_0) {
buffer_arg7_0[i_0*1] = *(arg7_0 + (arg7_0_map0_0[i * 3 + i_0])* 1);
};
for (int i_0=0; i_0<3; ++i_0) {
buffer_arg8_0[i_0*1] = *(arg8_0 + (arg8_0_map0_0[i * 3 + i_0])* 1);
};
for (int i_0=0; i_0<6; ++i_0) {
buffer_arg9_0[i_0*1] = *(arg9_0 + (arg9_0_map0_0[i * 6 + i_0])* 1);
}
    compile_slate(buffer_arg0_0, buffer_arg1_0, buffer_arg2_0, buffer_arg3_0, arg4_0, buffer_arg5_0, buffer_arg6_0, buffer_arg7_0, buffer_arg8_0, buffer_arg9_0, arg10_0 + (i * 6));
    for (int i_0=0; i_0<3; ++i_0) {
      *(arg0_0 + (arg0_0_map0_0[i * 3 + i_0])* 2) += buffer_arg0_0[i_0*2 + 0];
*(arg0_0 + (arg0_0_map0_0[i * 3 + i_0])* 2 + 1) += buffer_arg0_0[i_0*2 + 1 + 0];
    }
  }
  return 0;
}
