 ...
 static inline void subkernel1_exterior_facet_to_2_exterior_facet_integral_2 (const Eigen::MatrixBase<Derived> &  A_ , const double *restrict coords , const double *restrict w_0 , const unsigned int  facet[1] )
{
 ...
 static inline void compile_slate (double  A4[3] , double *  coords , double *  w_0 , double *  w_1 , double *  w_2 , double *  w_3 , double *  w_4 , double *  w_5 , double *  w_6 , int8_t *  arg_cell_facets )
{
  ...
  for (unsigned int  i1  = 0; i1 < 6; i1 += 1)
  {
    ...
    {
      VT2[0 + ((1 * i1) + j1)] = w_6[(i1 * 1) + j1];
      
    }
    
  }
  /* Auxiliary temporaries */
  Eigen::Matrix<double, 3, 6, Eigen::RowMajor>  auxT3 ;
  auxT3.setZero();
  /* Assign auxiliary temps */
  auxT3 = ((T0).block<3, 6>(6, 0)) * ((T0).block<6, 6>(0, 0)).inverse();
  /* Map eigen tensor into C struct */
  Eigen::Map<Eigen::Matrix<double, 3, 1> > T4((double *)A4);
  /* Linear algebra expression */
  T4 += (((T0).block<3, 3>(6, 6)) + (-auxT3 * ((T0).block<6, 3>(0, 6)))).inverse() * (((T1).block<3, 1>(6, 0)) + (-auxT3 * ((T1).block<6, 1>(0, 0))) + (-(((T0).block<3, 6>(6, 9)) + (-auxT3 * ((T0).block<6, 6>(0, 9)))) * VT2));
...
PetscErrorCode wrap_compile_slate(int start,
                      int end,
                      double *arg0_0, int32_t *arg0_0_map0_0, double *arg1_0, int32_t *arg1_0_map0_0, double *arg2_0, int32_t *arg2_0_map0_0, double *arg3_0, int32_t *arg3_0_map0_0, double *arg4_0, double *arg5_0, int32_t *arg5_0_map0_0, double *arg6_0, int32_t *arg6_0_map0_0, double *arg7_0, int32_t *arg7_0_map0_0, double *arg8_0, int32_t *arg8_0_map0_0, int8_t *arg9_0
                      ) {
  PetscErrorCode ierr;
...
double buffer_arg8_0[6] __attribute__((aligned(16)));
...
buffer_arg8_0[i_0*1] = *(arg8_0 + (arg8_0_map0_0[i * 6 + i_0])* 1);
}
    compile_slate(buffer_arg0_0, buffer_arg1_0, buffer_arg2_0, buffer_arg3_0, arg4_0, buffer_arg5_0, buffer_arg6_0, buffer_arg7_0, buffer_arg8_0, arg9_0 + (i * 6));
    for (int i_0=0; i_0<3; ++i_0) {
